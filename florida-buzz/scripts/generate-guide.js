...
// Splits the guide's HTML on paragraph/list boundaries and drops the box in
// around the midpoint, rather than always at the very end — so it reads as
// part of the article instead of a tacked-on footer. Falls back to appending
// at the end if the content is too short to have a clean midpoint.
